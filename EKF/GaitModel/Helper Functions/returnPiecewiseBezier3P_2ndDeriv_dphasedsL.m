function output = returnPiecewiseBezier3P_2ndDeriv_dphasedsL(phase,stepLength,incline,h_piecewise, phaseDelins,numFuncs)
    ...
    for i = 1:length(phase)
        ...
        output(i) = h_piecewise(phaseIdxs)' * returnBezier3P_2ndDerivEval_dphasedsL(phase(i),stepLength,incline)';
