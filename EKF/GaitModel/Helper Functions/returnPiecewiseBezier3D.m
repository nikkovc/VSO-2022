function output = returnPiecewiseBezier3D(phase,stepLength,incline,h_piecewise, phaseDelins,numFuncs)
    ...
    for i = 1:length(phase)
        ...
        output(i) = h_piecewise(phaseIdxs)' * returnBezierEval3P_sL_incline(phase(i),stepLength,incline)';
