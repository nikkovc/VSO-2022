function output = returnPiecewiseBezier3P_2ndDeriv_dphasedincline(phase,stepLength,incline,h_piecewise, phaseDelins,numFuncs)
    ...
    for i = 1:length(phase)
        ...
        output(i) = h_piecewise(phaseIdxs)' * returnBezier3P_2ndDerivEval_dphasedincline(phase(i),stepLength,incline)';
