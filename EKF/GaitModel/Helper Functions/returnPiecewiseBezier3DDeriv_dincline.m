function output = returnPiecewiseBezier3DDeriv_dincline(phase,stepLength,incline,h_piecewise, phaseDelins,numFuncs)
    ...
    for i = 1:length(phase)
        ...
        output(i) = h_piecewise(phaseIdxs)' * returnBezier3P_sL_incline_DerivEval_dincline(phase(i),stepLength,incline)';
